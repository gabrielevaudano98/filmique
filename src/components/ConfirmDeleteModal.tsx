    ...
    <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center z-[60] p-4">
      <div className="bg-white/80 dark:bg-neutral-800/60 backdrop-blur-lg border border-white/40 dark:border-neutral-700/50 rounded-2xl max-w-sm w-full p-6 shadow-none">
        ...
        <div className="flex justify-end space-x-3">
          <button onClick={onClose} className="px-4 py-2 rounded-lg bg-neutral-200 dark:bg-neutral-700 hover:bg-neutral-300 dark:hover:bg-neutral-600 font-semibold transition-colors text-black dark:text-white">
            Cancel
          </button>
          <button
            onClick={onConfirm}
