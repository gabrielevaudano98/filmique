  ...
  if (hasPermission === null) {
    return (
      <div className="h-screen flex flex-col items-center justify-center bg-black text-white">
        <div className="relative w-20 h-20 text-neutral-600 animate-pulse-soft">
          ...
          <Camera className="w-8 h-8 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-neutral-700" />
        </div>
      </div>
    );
  }
