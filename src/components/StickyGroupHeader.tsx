...
const StickyGroupHeader: React.FC<StickyGroupHeaderProps> = ({ children }) => {
  ...
  useEffect(() => {
    const observer = new IntersectionObserver(
      ...
      { threshold: [1], rootMargin: "-133px 0px 0px 0px" } // Matches the `top-[132px]` style
    );
  ...
  return (
    <h3
      ref={ref}
      className={`sticky top-[132px] z-20 py-2 -mx-4 px-4 text-lg font-bold text-white mb-3 border-y transition-colors duration-300
        ${isSticky 
